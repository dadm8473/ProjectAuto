const CACHE_NAME = 'projectauto-reboot-shell-v1';
const APP_SHELL_URLS = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/src/client/styles.css?v=shell-backdrop1',
  '/src/client/app.js?v=shell-backdrop1',
  '/src/client/reboot_actions.js?v=merge-reason1',
  '/src/client/reboot_action_ui.js?v=action-chip2',
  '/src/client/reboot_playtest.js?v=playtest1',
  '/src/client/reboot_preload.js?v=shell-backdrop1',
  '/src/client/reboot_render.js?v=unit-roster1',
  '/src/client/reboot_screens.js?v=objective-counter-plate1',
