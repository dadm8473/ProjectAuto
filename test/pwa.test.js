...
test('service worker keeps the installable mobile game shell available after first load', async () => {
  ...
  for (const marker of [
    "const CACHE_NAME = 'projectauto-reboot-shell-v92';",
    ...
    '/src/client/styles.css?v=meta-shelf-layout1',
    '/src/client/app.js?v=meta-shelf-layout1',
    ...
    '/src/client/reboot_preload.js?v=meta-shelf-layout1',
...
test('browser QA verifies the runtime service worker cache activation', async () => {
  ...
  for (const marker of [
    ...
    "cacheName === 'projectauto-reboot-shell-v92'",
    "await cache.match('/index.html')",
    "await cache.match('/src/client/styles.css?v=meta-shelf-layout1')",
    "await cache.match('/src/client/app.js?v=meta-shelf-layout1')",
    ...
    "await cache.match('/src/client/reboot_preload.js?v=meta-shelf-layout1')",
    "await cache.match('/src/client/reboot_render.js?v=battle-backdrop-v2')",
