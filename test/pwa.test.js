...
test('service worker keeps the installable mobile game shell available after first load', async () => {
  ...
  for (const marker of [
    "const CACHE_NAME = 'projectauto-reboot-shell-v42';",
    ...
    '/src/client/styles.css?v=shop-purpose1',
    '/src/client/app.js?v=shop-purpose1',
...
test('browser QA verifies the runtime service worker cache activation', async () => {
  ...
  for (const marker of [
    ...
    "cacheName === 'projectauto-reboot-shell-v42'",
    "await cache.match('/index.html')",
    "await cache.match('/src/client/styles.css?v=shop-purpose1')",
    "await cache.match('/src/client/app.js?v=shop-purpose1')",
    ...
    "await cache.match('/src/client/reboot_screens.js?v=shop-purpose1')",
