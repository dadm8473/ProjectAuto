...
test('browser QA verifies the runtime service worker cache activation', async () => {
  ...
  for (const marker of [
    ...
    "cacheName === 'projectauto-reboot-shell-v91'",
    "await cache.match('/index.html')",
    "await cache.match('/src/client/styles.css?v=combat-meter-sockets-v2')",
    "await cache.match('/src/client/app.js?v=combat-meter-sockets-v2')",
    ...
    "await cache.match('/src/client/reboot_preload.js?v=combat-meter-sockets-v2')",
