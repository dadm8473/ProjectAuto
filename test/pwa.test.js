...
test('service worker keeps the installable mobile game shell available after first load', async () => {
  ...
  for (const marker of [
    "const CACHE_NAME = 'projectauto-reboot-shell-v41';",
    ...
    '/src/client/styles.css?v=season-current1',
    '/src/client/app.js?v=season-current1',
    '/src/client/reboot_actions.js?v=combat-meter2',
    '/src/client/reboot_playtest.js?v=playtest2',
    '/src/client/reboot_render.js?v=p0-polish1',
...
test('browser QA verifies the runtime service worker cache activation', async () => {
  ...
  for (const marker of [
    ...
    "cacheName === 'projectauto-reboot-shell-v41'",
    "await cache.match('/index.html')",
    "await cache.match('/src/client/styles.css?v=season-current1')",
    "await cache.match('/src/client/app.js?v=season-current1')",
    ...
    "await cache.match('/src/client/reboot_render.js?v=p0-polish1')",
    "await cache.match('/src/client/reboot_screens.js?v=season-current1')",
    "await cache.match('/src/shared/game.js?v=boss-vitality1')",
    "await cache.match('/src/shared/reboot_game.js?v=boss-vitality1')",
    "await cache.match('/src/client/reboot_action_ui.js?v=cooldown-sweep1')",
