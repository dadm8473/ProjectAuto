...
test('service worker keeps the installable mobile game shell available after first load', async () => {
  ...
  for (const marker of [
    "const CACHE_NAME = 'projectauto-reboot-shell-v124';",
    ...
    '/src/client/app.js?v=operation-combat-cutin1',
    ...
    '/src/client/reboot_render.js?v=operation-combat-cutin1',
...
test('browser QA verifies the runtime service worker cache activation', async () => {
  ...
  for (const marker of [
    ...
    "cacheName === 'projectauto-reboot-shell-v124'",
    "await cache.match('/index.html')",
    "await cache.match('/src/client/styles.css?v=lobby-poster-crop1')",
    "await cache.match('/src/client/app.js?v=operation-combat-cutin1')",
    ...
    "await cache.match('/src/client/reboot_render.js?v=operation-combat-cutin1')",
