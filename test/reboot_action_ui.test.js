...
test('partner danger meter uses role-first visible copy while keeping the partner name accessible', () => {
  const current = {
...
test('partner danger meter uses role-first label regardless of partner identity', () => {
  const current = {
